...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        header("Location: seafood hotpot.php");
...
<body>
    ...
    <section class="categories">
        <div class="container">
            ...
            <h3 class="text-center">Seafood Hotpot (4 Persons)</h3>


            <div class="box-3 float-container">
                <img src="seafood category.png" alt="Seafood Based" style="width: 200%; border-style: solid; border-color: black; border-radius: 2%; border-width: 5px;">
            </div>
        </div>
    </section>
    ...
    <table style="width: 50%;">
        <tr>
            <td style="width: 40%; ">
                <form id="seafoodHotpotForm" style="background-color:white; width: 80%; margin-left: 350px; border-radius: 20px;" action="seafood hotpot.php" method="POST">
                    <input type="hidden" name="formName" value="Seafood Hotpot">
