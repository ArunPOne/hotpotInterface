...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        header("Location: chicken hotpot.php");
...
<body>
    ...
    <section class="categories">
        <div class="container">
            ...
            <h3 class="text-center">Chicken Hotpot (4 Persons)</h3>


            <div class="box-3 float-container">
                <img src="chicken category.png" alt="Chicken Based" style="width: 200%; border-style: solid; border-color: black; border-radius: 2%; border-width: 5px;">
            </div>
        </div>
    </section>
    ...
    <table style="width: 50%;">
        <tr>
            <td style="width: 40%; ">
                <form id="chickenHotpotForm" style="background-color:white; width: 80%; margin-left: 350px; border-radius: 20px;" action="chicken hotpot.php" method="POST">
                    <input type="hidden" name="formName" value="Chicken Hotpot">
                    ...
                    <div class="container" style="margin-left: 40%; cursor:pointer">
                    ...
                    <div class="container" style="margin-left: 40%;cursor:pointer;">
                        <input type="checkbox" name="vegetable[]" value="Spinach"> Spinach<br>

                        <input type="checkbox" name="vegetable[]" value="Lettuce"> Lettuce<br>

                        <input type="checkbox" name="vegetable[]" value="Lotus Root"> Lotus Root<br>

                        <input type="checkbox" name="vegetable[]" value="Sweetcorns"> Sweet Corns<br>

                        <input type="checkbox" name="vegetable[]" value="Potato Slices"> Potato Slices<br>

                        <input type="checkbox" name="vegetable[]" value="Yaumak"> Yau Mak<br>
                    </div>
                    ...
                    <div class="container" style="margin-left: 10%;">
                        <input type="checkbox" name="addon[]" value="Tiger Prawn"> Tiger Prawn (RM9)<br><br>

                        <input type="checkbox" name="addon[]" value="Baby Octopus"> Baby Octopus (RM9)<br><br>

                        <input type="checkbox" name="addon[]" value="Fish Balls"> Fish Balls (RM8)<br><br>

                        <input type="checkbox" name="addon[]" value="Dried Tofu Skin"> Sliced Barramundi (RM7)<br><br>

                    </div>

                    <div class="container" style="margin-left: 60%; margin-top: -160px;">

                        <input type="checkbox" name="addon[]" value="Green Mussel"> Green Mussel (RM9)<br><br>

                        <input type="checkbox" name="addon[]" value="Baby Cuttlefish"> Baby Cuttlefish (RM6)<br><br>

                        <input type="checkbox" name="addon[]" value="Golden Mushroom"> Golden Mushroom (RM8)<br><br>

                        <input type="checkbox" name="addon[]" value="Egg"> Egg (RM5)
                    </div>
