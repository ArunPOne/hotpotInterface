...
<body>
    ...
    <section class="dashboard">
        ...
        <br>
        <p style="font-size:25px; font-family: 'Poppins', sans-serif; "><b>Menu Details </b></h1>
            <br>
            <br>
        ...
        <br>
        <button onclick="window.location.href='editadminmenu.php'" style="margin-left: 5%;background-color:blue; color:white;border: none;padding: 6px 34px;font-size:15px;" type="button">Edit</button>
